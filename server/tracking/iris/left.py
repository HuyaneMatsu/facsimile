...
from ..face_mesh_points import (
    ...
    FACE_MESH_POINT__EYE_OUTLINE_LEFT__BOT_1, FACE_MESH_POINT__EYE_OUTLINE_LEFT__TOP_1,
...
def get_left_iris_rotations(landmarks):
    ratios = get_iris_rotations(
        ...
        landmarks[FACE_MESH_POINT__EYE_OUTLINE_LEFT__TOP_1],
        landmarks[FACE_MESH_POINT__EYE_OUTLINE_LEFT__BOT_1],
